...
export default class CreateShipment extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/createshipments/add', newShipment)
            ...
            return (
                <>
                    <form id="contact-form" className="needs-validation" onSubmit={this.onSubmit} noValidate>
                        <fieldset>
                            <legend><h1>Create Shipment</h1></legend>
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <input type="text" className="form-control" id="firstName" placeholder="Senders Address" value={this.state.sendersaddress} onChange={this.onChangeSendersAddress} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="lastName">Senders Phone</label>
                                    <input type="number" className="form-control" id="lastName" placeholder="Senders Phone" value={this.state.sendersphone} onChange={this.onChangeSendersPhone} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="city">Senders Email</label>
                                    <input type="text" className="form-control" id="city" placeholder="Senders Email" value={this.state.sendersemail} onChange={this.onChangeSendersEmail} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="firstName">Receivers Name</label>
                                    <input type="text" className="form-control" id="firstName" placeholder="Receivers Name" value={this.state.receiversname} onChange={this.onChangeReceiversName} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="firstName">Receivers Address</label>
                                    <input type="text" className="form-control" id="firstName" placeholder="Receivers Address" value={this.state.receiversaddress} onChange={this.onChangeReceiversAddress} required />

                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="lastName">Receivers Phone</label>
                                    <input type="number" className="form-control" id="lastName" placeholder="Receivers Phone" value={this.state.receiversphone} onChange={this.onChangeLastname} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="city">Receivers Email</label>
                                    <input type="text" className="form-control" id="city" placeholder="Receivers Email" value={this.state.receiversemail} onChange={this.onChangeReceiversEmail} required />
                                </div>


                                <div className="col-md-6">
                                    <label htmlFor="email">Origin</label>
                                    <input type="text" className="form-control" id="email" placeholder="Origin" value={this.state.origin} onChange={this.onChangeOrigin} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="number">Package</label>
                                    <input type="text" className="form-control" id="email" placeholder="Package" value={this.state.package} onChange={this.onChangePackage} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="firstName">Status</label>
                                    <input type="text" className="form-control" id="firstName" placeholder="Status" value={this.state.status} onChange={this.onChangeStatus} required />

                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="lastName">Destination</label>
                                    <input type="text" className="form-control" id="lastName" placeholder="Destination" value={this.state.destination} onChange={this.onChangeDestination} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="city">Carrier</label>
                                    <input type="text" className="form-control" id="city" placeholder="Carrier" value={this.state.carrier} onChange={this.onChangeCarrier} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="firstName">Type of Shipment</label>
                                    <input type="text" className="form-control" id="firstName" placeholder="Type of Shipment" value={this.state.typeofshipment} onChange={this.onChangeTypeOfShipment} required />

                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="lastName">Weight</label>
                                    <input type="number" className="form-control" id="lastName" placeholder="Weight" value={this.state.number} onChange={this.onChangeWeight} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="city">Shipment Mode</label>
                                    <input type="text" className="form-control" id="city" placeholder="Shipment  Mode" value={this.state.shipmentmode} onChange={this.onChangeShipmentMode} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="firstName">Product</label>
                                    <input type="text" className="form-control" id="firstName" placeholder="Product" value={this.state.product} onChange={this.onChangeProduct} required />

                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="lastName">Quantity</label>
                                    <input type="text" className="form-control" id="lastName" placeholder="Quantity" value={this.state.quantity} onChange={this.onChangeQuantity} required />
                                </div>

                                <div className="col-md-6">
                                    <label htmlFor="city">Waybill or Tracking Number</label>
                                    <input type="number" className="form-control" id="city" placeholder="Waybill or Tracking Number" value={this.state.waybill} onChange={this.onChangeWaybill} required />
                                </div>
                            </div>
